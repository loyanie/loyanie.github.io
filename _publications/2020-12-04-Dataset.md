...
The dataset contains only Red-Green-Blue (RGB) colored images. The annotated dataset freely available to other researchers through an open access repository to facilitate further research in diagnosing Tuta absoluta’s damage to tomato plants'
date: 2020-12-04
venue: 'Zenodo'
